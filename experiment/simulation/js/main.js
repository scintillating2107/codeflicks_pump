...
function startSimulation() {
    ...
    updateSimulationStatus('running', '🔄 Simulation Running...');
    
    // Add button loading effect
    startBtn.innerHTML = '<div class="loading"></div> Starting...';
    
    setTimeout(() => {
        startBtn.innerHTML = '▶️ Start Simulation';
    }, 1000);
    ...
    setTimeout(() => {
        ...
        updateSimulationStatus('idle', '✅ Simulation Complete');
        
        // Show completion notification
        setTimeout(() => {
            updateSimulationStatus('idle', 'System Ready');
        }, 3000);
...
function stopSimulation() {
    ...
    // Update simulation status
    updateSimulationStatus('idle', '⏹️ Simulation Stopped');
...
function resetSimulation() {
    ...
    // Update simulation status
    updateSimulationStatus('idle', '🔄 System Reset');
